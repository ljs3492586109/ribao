...
-- 修正：补全 JOIN 条件
    ...
    where dt = '2025-07-18' and is_deleted = '0'
...
set hive.exec.dynamic.partition.mode=nonstrict;
set hive.exec.dynamic.partition=true; -- 启用动态分区（默认开启）
set hive.exec.max.dynamic.partitions=10000; -- 最大动态分区数（按需调大）
