...
/**
 * Title: DbusDwdTradeOrderDetailToKafka
 * Author: hyx
 * Package: groupId.retailersv1.dwd
 * Date: 2025/8/20 20:04
 * Description: 交易域下单事务事实表
 */
public class DbusDwdTradeOrderDetailToKafka {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE ods_all_cdc (\n" +
                ...
                ")" + SqlUtil.getKafka(ODS_KAFKA_TOPIC, "retailersv_ods_all_cdc"));
        //tableEnv.executeSql("select * from ods_all_cdc where `source`['table'] = 'order_detail' ").print();
