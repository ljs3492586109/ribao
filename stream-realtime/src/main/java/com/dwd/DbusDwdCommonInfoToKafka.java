...
/**
 * Title: DbusDwdCommonInfo2Kafka
 * Author: hyx
 * Package: groupId.retailersv1.dwd
 * Date: 2025/8/20 15:21
 * Description: 评论事实表
 */
public class DbusDwdCommonInfoToKafka {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE ods_all_cdc (\n" +
                ...
                ")" + SqlUtil.getKafka(ODS_KAFKA_TOPIC, "retailersv1_ods_all_cdc"));

 //tableEnv.executeSql("select * from ods_all_cdc where `source`['table'] = 'comment_info' ").print();
